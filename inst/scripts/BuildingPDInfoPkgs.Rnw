...
\section{Affymetrix SNP Array}
\label{sec:affysnp}

The annotation packages for any Affymetrix SNP chip is available from
BioConductor.
...
baseDir <- '/home/bst/student/bcarvalh/pdInfoVignette/AffyHTHGU133P'
...
<<affytiling>>=
baseDir <- '/home/bst/student/bcarvalh/pdInfoVignette/AffyTiling'
...
<<affyexon>>=
library(pdInfoBuilder)
baseDir <- '/home/bst/student/bcarvalh/pdInfoVignette/AffyExon'
...
<<affyexon>>=
library(pdInfoBuilder)
baseDir <- '/home/bst/student/bcarvalh/pdInfoVignette/AffyGene'
(pgf <- list.files(baseDir, pattern='.pgf', full.names=TRUE))
(clf <- list.files(baseDir, pattern='.clf', full.names=TRUE))
(prob <- list.files(baseDir, pattern='.probeset.csv', full.names=TRUE))
seed <- new("AffySTPDInfoPkgSeed",
...
<<ngsexpr>>=
library(pdInfoBuilder)
baseDir <- '/home/bst/student/bcarvalh/pdInfoVignette/NgsExpression'
